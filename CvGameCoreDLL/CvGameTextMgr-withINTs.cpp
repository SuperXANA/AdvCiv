	...
	bool bDawnOfMan, bool bLinks)
{
	...
	FOR_EACH_ENUM(Terrain)
	{
		FOR_EACH_ENUM(Yield)
		{
			int iTerrainYieldChange = GC.getCivilizationInfo(eCivilization).getTerrainYieldChanges((int)eLoopTerrain, (int)eLoopYield, false);
			if (iTerrainYieldChange != 0) {
				...
				CvWString szText = gDLL->getText("TXT_KEY_MISC_CIV_TERRAIN_MOD", iTerrainYieldChange, GC.getYieldInfo(eLoopYield).getChar(), GC.getTerrainInfo(eLoopTerrain).getTextKeyWide());
				if (bDawnOfMan)
				{
					szBuffer.Format(L"    %s\n", szText.GetCString());
					szInfoText.append(szBuffer);
			...
			int iTerrainRiverYieldChange = GC.getCivilizationInfo(eCivilization).getTerrainYieldChanges((int)eLoopTerrain, (int)eLoopYield, true);
			if (iTerrainRiverYieldChange != 0 && iTerrainRiverYieldChange != iTerrainYieldChange)
			{
				...
				CvWString szText = gDLL->getText("TXT_KEY_MISC_CIV_TERRAIN_RIVER_MOD", iTerrainRiverYieldChange, GC.getYieldInfo(eLoopYield).getChar(), GC.getTerrainInfo(eLoopTerrain).getTextKeyWide());
				if (bDawnOfMan)
				{
					szBuffer.Format(L"    %s\n", szText.GetCString());
					szInfoText.append(szBuffer);
