...
void CvEventInfo::read(FDataStreamBase* stream)
{
	...
	stream->Read(&m_iPrereqNotLeader);
	stream->Read(&m_iPrereqCivilization);
	stream->Read(&m_iPrereqNotCivilization);
	stream->Read(&m_iPrereqOtherLeader);
	stream->Read(&m_iPrereqOtherNotLeader);
	stream->Read(&m_iPrereqOtherCivilization);
	stream->Read(&m_iPrereqOtherNotCivilization);
	// XANA: FfH Events for AdvancedCiv 03-01-2025
}
...
void CvEventInfo::write(FDataStreamBase* stream)
{
	...
	stream->Write(m_iPrereqNotLeader);
	stream->Write(m_iPrereqCivilization);
	stream->Write(m_iPrereqNotCivilization);
	stream->Write(m_iPrereqOtherLeader);
	stream->Write(m_iPrereqOtherNotLeader);
	stream->Write(m_iPrereqOtherCivilization);
	stream->Write(m_iPrereqOtherNotCivilization);
	// XANA: FfH Events for AdvancedCiv 03-01-2025
}
#endif
