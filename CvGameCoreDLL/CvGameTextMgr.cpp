	...
	EventTypes eEvent, int iEventTriggeredId, PlayerTypes ePlayer)
{
	...
	if (kEvent.getPrereqLeader() != NO_LEADER)
	{
        ...
        {
            szBuffer.append(NEWLINE);
            szBuffer.append(gDLL->getText("TXT_KEY_THIS_REQUIRES", GC.getLeaderHeadInfo((LeaderHeadTypes)kEvent.getPrereqLeader()).getDescription()));
        }
	}
	if (kEvent.getPrereqNotLeader() != NO_LEADER)
	{
        ...
        {
            szBuffer.append(NEWLINE);
            szBuffer.append(gDLL->getText("TXT_KEY_THIS_REQUIRES_NOT", GC.getLeaderHeadInfo((LeaderHeadTypes)kEvent.getPrereqNotLeader()).getDescription()));
        }
	}
	if (kEvent.getPrereqCivilization() != NO_CIVILIZATION)
	{
        ...
        {
            szBuffer.append(NEWLINE);
            szBuffer.append(gDLL->getText("TXT_KEY_THIS_REQUIRES", GC.getCivilizationInfo((CivilizationTypes)kEvent.getPrereqCivilization()).getDescription()));
        }
	}
	if (kEvent.getPrereqNotCivilization() != NO_CIVILIZATION)
	{
        ...
        {
            szBuffer.append(NEWLINE);
            szBuffer.append(gDLL->getText("TXT_KEY_THIS_REQUIRES_NOT", GC.getCivilizationInfo((CivilizationTypes)kEvent.getPrereqNotCivilization()).getDescription()));
        }
	}
	if (pTriggeredData->m_eOtherPlayer != NO_PLAYER)
	{
		if (kEvent.getPrereqOtherLeader() != NO_LEADER)
		{
			...
			{
				szBuffer.append(NEWLINE);
				szBuffer.append(gDLL->getText("TXT_KEY_THIS_ALSO_REQUIRES", GC.getLeaderHeadInfo((LeaderHeadTypes)kEvent.getPrereqOtherLeader()).getDescription()));
			}
		}
		if (kEvent.getPrereqOtherNotLeader() != NO_LEADER)
		{
			...
			{
				szBuffer.append(NEWLINE);
				szBuffer.append(gDLL->getText("TXT_KEY_THIS_ALSO_REQUIRES_NOT", GC.getLeaderHeadInfo((LeaderHeadTypes)kEvent.getPrereqOtherNotLeader()).getDescription()));
			}
		}
		if (kEvent.getPrereqOtherCivilization() != NO_CIVILIZATION)
		{
			...
			{
				szBuffer.append(NEWLINE);
				szBuffer.append(gDLL->getText("TXT_KEY_THIS_ALSO_REQUIRES", GC.getCivilizationInfo((CivilizationTypes)kEvent.getPrereqOtherCivilization()).getDescription()));
			}
        }
		if (kEvent.getPrereqOtherNotCivilization() != NO_CIVILIZATION)
		{
			...
			{
				szBuffer.append(NEWLINE);
				szBuffer.append(gDLL->getText("TXT_KEY_THIS_ALSO_REQUIRES_NOT", GC.getCivilizationInfo((CivilizationTypes)kEvent.getPrereqOtherNotCivilization()).getDescription()));
			}
        }
	}
	// XANA: FfH Events for AdvancedCiv 03-01-2025
