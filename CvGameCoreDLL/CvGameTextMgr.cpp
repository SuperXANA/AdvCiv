	...
	bool bDawnOfMan, bool bLinks)
{
	...
	FOR_EACH_ENUM(Terrain)
	{
		FOR_EACH_ENUM(Yield)
		{
			int iTerrainYieldChange = GC.getCivilizationInfo(eCivilization).getTerrainYieldChanges(eLoopTerrain, eLoopYield, false);
			...
			int iTerrainRiverYieldChange = GC.getCivilizationInfo(eCivilization).getTerrainYieldChanges(eLoopTerrain, eLoopYield, true);
