...
ENUM_START(AlignmentFaction, ALIGNMENTFACTION)
	ALIGNMENTFACTION_LIGHT,
	ALIGNMENTFACTION_NEUTRAL,
	ALIGNMENTFACTION_DARK,
ENUM_END(AlignmentFaction, ALIGNMENTFACTION)
// XANA: 02-14-2026 FfH Faction Alignment for Advanced Civ
