...
ENUM_START(PromotionChange, PROMOTIONCHANGE)
	PROMOTIONCHANGE_ADD,
	PROMOTIONCHANGE_ADD_TIMED,
	PROMOTIONCHANGE_REMOVE,
	PROMOTIONCHANGE_REMOVE_TIMED,
ENUM_END(PromotionChange, PROMOTIONCHANGE)
// XANA: 08-26-2025 RPG Unit Equipment for AdvancedCiv
