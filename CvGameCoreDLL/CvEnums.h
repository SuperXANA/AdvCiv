...
ENUM_START(AlignmentFaction, ALIGNMENT_FACTION)
	...
	ALIGNMENT_FACTION_SHADOW,
	ALIGNMENT_FACTION_DARK,
...
ENUM_START(Emotion, EMOTION)
	EMOTION_CALM,		 // Default when nothing is happening
	EMOTION_ANGRY,       // Betrayal, broken deals
	EMOTION_FEARFUL,     // Power disparity
	EMOTION_GREEDY,      // See opportunity
	EMOTION_GRATEFUL,    // Recent gift/rescue
	EMOTION_CONFIDENT,	 // Known advntage, self-satisfied
	EMOTION_SUSPICIOUS,  // Unknown intentions
...
#define NO_MEMORY_HYPERPLANE (-1)
#define NO_MEMORY_FEATURE (-1)
#define NUM_MEMORY_HYPERPLANE_TYPES (8)
#define NUM_MEMORY_FEATURE_TYPES (6)

ENUM_START(AIMemoryContext, AI_MEMORY_CONTEXT)
	AI_MEMORY_CONTEXT_WAR_DECLARATION,
	AI_MEMORY_CONTEXT_HIRED_WAR_ALLY,
	AI_MEMORY_CONTEXT_DEPLOYED_NUKE,
	AI_MEMORY_CONTEXT_CAPTURED_CITY,
	AI_MEMORY_CONTEXT_RAZED_CITY,
	AI_MEMORY_CONTEXT_SPY_CAUGHT,
	AI_MEMORY_CONTEXT_REQUEST_TO_HELP,
	AI_MEMORY_CONTEXT_RELIGION_CHANGE,
	AI_MEMORY_CONTEXT_CIVIC_CHANGE,
	AI_MEMORY_CONTEXT_REQUEST_FOR_AID_IN_WAR,
	AI_MEMORY_CONTEXT_ACCEPTED_STOP_TRADING,
	AI_MEMORY_CONTEXT_DENIED_STOP_TRADING,
	AI_MEMORY_CONTEXT_STOPPED_TRADING,
	AI_MEMORY_CONTEXT_HIRED_TRADE_EMBARGO,
	AI_MEMORY_CONTEXT_MADE_DEMAND,
	AI_MEMORY_CONTEXT_CANCELLED_OPEN_BORDERS,
	AI_MEMORY_CONTEXT_CANCELLED_DEFENSIVE_PACT, // advc.130p
	AI_MEMORY_CONTEXT_PERFOMED_TECH_TRADE,
	AI_MEMORY_CONTEXT_GOT_TECH_FROM_US,
	AI_MEMORY_CONTEXT_GOT_TECH_FROM_OTHER,
	AI_MEMORY_CONTEXT_VOTED_AGAINST_US,
	AI_MEMORY_CONTEXT_VOTED_FOR_US,
	AI_MEMORY_CONTEXT_EVENT_GOOD_TO_US,
	AI_MEMORY_CONTEXT_EVENT_BAD_TO_US,
	AI_MEMORY_CONTEXT_LIBERATED_CITY,
ENUM_END(AIMemoryContext, AI_MEMORY_CONTEXT)
// XANA: 05-02-2026 Realism System for Civ4 Game Artificial Intelligence
