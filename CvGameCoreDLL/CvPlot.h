...
#include "DefenderFilters.h" // advc
...
public:
	...
	// </advc>
	// advco.defr:
	void unavailableDefendersVsActivePlayer(std::set<CvUnit const*>& apDef) const;
...
BOOST_STATIC_ASSERT(MAX_PLOT_NUM > MAX_SHORT || sizeof(CvPlot) <= 272);
