...
public:
	...
	bool getOtherCivilizationTypes(int i, int j) const;
	bool getOtherNotCivilizationTypes(int i, int j) const;
	// XANA: 03-29-2025 Leader_Amd_Civilization-Specific Diplomacy Texts for AdvancedCiv
	bool getLeaderHeadTypes(int i, int j) const;
	// XANA: 03-29-2025 Leader_Amd_Civilization-Specific Diplomacy Texts for AdvancedCiv
	bool getOtherLeaderHeadTypes(int i, int j) const;
	bool getOtherNotLeaderHeadTypes(int i, int j) const;
	// XANA: 03-29-2025 Leader_Amd_Civilization-Specific Diplomacy Texts for AdvancedCiv
