...
// XANA: 06-07-2025 Leader Specific Favorite Unit Combat Type
	allocCopy(m_piUnitCombatWeights, kOther.m_piUnitCombatWeights, GC.getNumUnitCombatInfos());
// XANA: 06-07-2025 Leader Specific Favorite Unit Combat Type
} // </advc.xmldefault>
...
// XANA: 06-07-2025 Leader-Specific Favorite Unit Combat Type
int CvLeaderHeadInfo::getFavoriteUnitCombatWeight(UnitCombatTypes eUnitCombat) const
{
	FAssertBounds(0, GC.getNumUnitCombatInfos(), eUnitCombat);
	return m_piUnitCombatWeights ? (m_piUnitCombatWeights[eUnitCombat] / 100) : 0;
}
// XANA: 06-07-2025 Leader-Specific Favorite Unit Combat Type
...
void CvLeaderHeadInfo::read(FDataStreamBase* stream)
{
	...
	// XANA: 06-07-2025 Leader-Specific Favorite Unit Combat Type
	SAFE_DELETE_ARRAY(m_piUnitCombatWeights);
	m_piUnitCombatWeights = new int[GC.getNumUnitCombatInfos()];
	stream->Read(GC.getNumUnitCombatInfos(), m_piUnitCombatWeights);
	// XANA: 06-07-2025 Leader-Specific Favorite Unit Combat Type
}
...
void CvLeaderHeadInfo::write(FDataStreamBase* stream)
{
	...
	// XANA: 06-07-2025 Leader-Specific Favorite Unit Combat Type
	stream->Write(GC.getNumUnitCombatInfos(), m_piUnitCombatWeights);
	// XANA: 06-07-2025 Leader-Specific Favorite Unit Combat Type
}
#endif
...
bool CvLeaderHeadInfo::read(CvXMLLoadUtility* pXML)
{
	...
	// XANA: 06-07-2025 Leader-Specific Favorite Unit Combat Type
	pXML->SetVariableListTagPair(&m_piUnitCombatWeights, "FavoriteUnitCombats", GC.getNumUnitCombatInfos());
	// XANA: 06-07-2025 Leader-Specific Favorite Unit Combat Type
