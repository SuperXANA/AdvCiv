...
m_iDemandRebukedWarProb(0),
	// XANA: 11-08-2025 Leader Specific AI Renegade Team Diplomacy
m_iRenegadeFromTeamDiploProb(0),
	// XANA: 11-08-2025 Leader Specific AI Renegade Team Diplomacy
m_iRazeCityProb(0),
m_iBuildUnitProb(0),
...
void CvLeaderHeadInfo::read(FDataStreamBase* stream)
{
	...
	// XANA: 11-08-2025 Leader Specific AI Renegade Team Diplomacy
	stream->Read(&m_iRenegadeFromTeamDiploProb);
	// XANA: 11-08-2025 Leader Specific AI Renegade Team Diplomacy
...
void CvLeaderHeadInfo::write(FDataStreamBase* stream)
{
	...
	// XANA: 11-08-2025 Leader Specific AI Renegade Team Diplomacy
	stream->Write(m_iRenegadeFromTeamDiploProb);
	// XANA: 11-08-2025 Leader Specific AI Renegade Team Diplomacy
...
bool CvLeaderHeadInfo::read(CvXMLLoadUtility* pXML)
{
	...
	// XANA: 11-08-2025 Leader Specific AI Renegade Team Diplomacy
	GetChildXmlValByName(m_iRenegadeFromTeamDiploProb, "iRenegadeFromTeamDiploProb");
	// XANA: 11-08-2025 Leader Specific AI Renegade Team Diplomacy
